...
local Tabs = {
    ...
    Stats = Window:AddTab({ Title = "Stats", Icon = "badge-plus" }),
    Player = Window:AddTab({ Title = "Player", Icon = "smile" }),
    Teleport = Window:AddTab({ Title = "Teleport", Icon = "laptop-minimal" }),
    Fruit = Window:AddTab({ Title = "Devil Fruit", Icon = "apple" }),
    Raid = Window:AddTab({ Title = "Dungeon", Icon = "swords" }),
    Race = Window:AddTab({ Title = "Race V4", Icon = "flag" }),
...
--Create Tabs
    Tabs.Main:AddParagraph({
        Title = "Auto Farm",
        Content = "Auto Farm And Level Up"
    })
    ...
    spawn(function()
      ...
      Tabs.Main:AddButton({
        Title = "Redeem 2x Codes",
        Description = "Redeem All 2x Codes",
        Callback = function()
            UseCode()
        end
    })
...
--Mastery
    ...
    local ToggleMasteryFruit = Tabs.Main:AddToggle("ToggleMasteryFruit", {Title = "Auto Blox Fruit Mastery", Default = false })
...
if Third_Sea then
   ...
   ToggleTW:OnChanged(function(Value)
    ...
    spawn(function()
     ...
     Tabs.Main:AddParagraph({
        Title = "Elite Hunter",
        Content = "Auto Find And Auto Defeat Elite Boss"
    })
...
local ToggleFruit = Tabs.Stats:AddToggle("ToggleFruit", {Title = "Auto Devil Fruit", Default = false })
...
local ToggleFruit = Tabs.Fruit:AddToggle("ToggleFruit", {Title = "Buy Fruit (Fruit Snipe)", Default = false })
ToggleFruit:OnChanged(function(Value)
...
local ToggleEspIsland = Tabs.Fruit:AddToggle("ToggleEspIsland", {Title = "ESP Islands", Default = false })
...
local ToggleEspFlower = Tabs.Fruit:AddToggle("ToggleEspFlower", {Title = "ESP Flowers", Default = false })
