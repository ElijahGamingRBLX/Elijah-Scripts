		...
		local Window = OrionLib:MakeWindow({Name = "Elijah Hub - Evade", HidePremium = false,IntroText = "Elijah Hub", SaveConfig = false, ConfigFolder = "OrionTest"})
		...
		function SpamChat()
			while autochat == true do
				local ohString1 = "Elijah Hub On Top"
				local ohString2 = "All"
		...
		function RandomEmote()
			OrionLib:MakeNotification({
				Name = "Random Emoting...",
				Content = "You Pressed Random Emote Bind",
		...
		MiscTab:AddButton({
			Name = "Low Quality (Best For Mobile)",
			Callback = function()
		...
		TeleportTab:AddButton({
			Name = "Join Team Deathmatch (Server)",
			Callback = function()
				local TeleportService = game:GetService('TeleportService')
				GameId = 110539706691
				TeleportService:Teleport(GameId, game.Players.LocalPlayer)
		...
		CreditsTab:AddParagraph("Made By Elijah","elijahgamingrblx")
		CreditsTab:AddParagraph("Credits","Elijah Hub")
